...
# این تابع باید به انتهای فایل ui/operation_menu.py اضافه شود:

def create_operation_menu(parent_menu):
    """
    ...
    operation_menu.add_item(create_action_item(
        "1", "Select Source Group", lambda: print("Select Source Group")))
    operation_menu.add_item(create_action_item(
        "2", "Select Target Group", lambda: print("Select Target Group")))
    operation_menu.add_item(create_action_item(
        "3", "Configure Operation Parameters", lambda: print("Configure Parameters")))
    operation_menu.add_item(create_action_item(
        "4", "Select Transfer Strategy", lambda: print("Select Strategy")))
    operation_menu.add_item(create_action_item(
        "5", "Start Operation", lambda: print("Start Operation")))
    operation_menu.add_item(create_action_item(
        "6", "View Results", lambda: print("View Results")))
