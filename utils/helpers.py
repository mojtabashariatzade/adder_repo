...
This module provides various helper functions used throughout the Telegram Account Manager application.
...
def get_project_root() -> Path:
    ...
    for _ in range(max_depth):
        if any((current_dir / indicator).exists() for indicator in ['.env', '.git', 'setup.py', 'pyproject.toml']):
            return current_dir
